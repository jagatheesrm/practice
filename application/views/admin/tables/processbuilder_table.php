...
$sIndexColumn     = 'id';
$sTable           = db_prefix() . 'labour_activity_list';
    ...
    for ($i = 0; $i < count($aColumns); $i++) {
        ...
        if ($aColumns[$i] == 'id') {
            ...
            if (has_permission('knowledge_base', '', 'delete')) {
                $_data .= ' | <a href="' . admin_url('processbuilder/delete_activity/' . $aRow['id']) . '" class="_delete text-danger">' . _l('delete') . '</a>';
            }
