                    ...
                    <div class="panel-body">
                        <div class="_buttons">
                            ...
                            <?php if ($has_permission_create) { ?>
                                <a href="#" onclick="new_service(); return false; " class="btn btn-info mright5"><?php echo 'New Business Type'; ?></a>
                                <a href="<?php echo admin_url('restaurant'); ?>" class="btn btn-info mleft4"><?php echo 'restaurant'; ?></a>
