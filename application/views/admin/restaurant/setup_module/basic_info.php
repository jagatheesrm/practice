         ...
         <div role="tabpanel" class="tab-pane<?php if (!$this->input->get('tab')) {
            ...
            <div class="row">
               ...
               <div class="col-md-<?php if (isset($restaurant_details[0]['restaurant_id'])) {
                  ...
                  <?php echo render_select_with_input_group('business_type', get_restaurant_types(), array('types', 'types'), 'Business Type', $value,'<a href="#" onclick="new_service(); return false; "><i class="fa fa-plus"></i></a>'); ?>
...
<!-- mail -->
                        ...
                        <div class="card-header">
                           <div class="custom-control custom-checkbox">
                              ...
                              <span class="ml-auto float-right"> <!-- This class will align content to the right -->
                                 <button class="btn btn-outline-success btn-sm js-whs__add-btn" type="button" id="sun[]">
                        ...
                        <div class="card-body">
                           <div class="row row1">
                              ...
                              <div class="col-6">
                                 <!-- <div class="form-group"> -->
                                    <div class="input-group">
                                       <input type="number" name="sun[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="12">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="sun[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                     ...
                     <div class="card mb-3">
                        <div class="card-header">
                           <div class="custom-control custom-checkbox">
                              ...
                              <span class="ml-auto float-right"> <!-- This class will align content to the right -->
                                 <button class="btn btn-outline-success btn-sm js-whs__add-btn" type="button" id="mon[]">
                                    <i class="bi bi-plus"></i> Add
                                 </button>
                              </span>
                           </div>
                        ...
                        <div class="card-body">
                           <div class="row row1">
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="mon[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="09">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="mon[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="mon[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="12">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="mon[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                     ...
                     <div class="card mb-3">
                        <div class="card-header">
                           <div class="custom-control custom-checkbox">
                              ...
                              <span class="ml-auto float-right"> <!-- This class will align content to the right -->
                                 <button class="btn btn-outline-success btn-sm js-whs__add-btn" type="button" id="tues[]">
                                    <i class="bi bi-plus"></i> Add
                                 </button>
                              </span>
                           </div>
                        ...
                        <div class="card-body">
                           <div class="row row1">
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="tues[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="09">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="tues[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="tues[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="12">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="tues[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                     ...
                     <div class="card mb-3">
                        <div class="card-header">
                           <div class="custom-control custom-checkbox">
                              ...
                              <span class="ml-auto float-right"> <!-- This class will align content to the right -->
                                 <button class="btn btn-outline-success btn-sm js-whs__add-btn" type="button" id="wed[]">
                                    <i class="bi bi-plus"></i> Add
                                 </button>
                              </span>
                           </div>
                        ...
                        <div class="card-body">
                           <div class="row row1">
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="wed[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="09">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="wed[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="wed[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="12">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="wed[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                     ...
                     <div class="card mb-3">
                        <div class="card-header">
                           <div class="custom-control custom-checkbox">
                              ...
                              <span class="ml-auto float-right"> <!-- This class will align content to the right -->
                                 <button class="btn btn-outline-success btn-sm js-whs__add-btn" type="button" id="thu[]">
                                    <i class="bi bi-plus"></i> Add
                                 </button>
                              </span>
                           </div>
                        ...
                        <div class="card-body">
                           <div class="row row1">
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="thu[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="09">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="thu[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="thu[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="12">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="thu[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                     ...
                     <div class="card mb-3">
                        <div class="card-header">
                           <div class="custom-control custom-checkbox">
                              ...
                              <span class="ml-auto float-right"> <!-- This class will align content to the right -->
                                 <button class="btn btn-outline-success btn-sm js-whs__add-btn" type="button" id="fri[]">
                                    <i class="bi bi-plus"></i> Add
                                 </button>
                              </span>
                           </div>
                        ...
                        <div class="card-body">
                           <div class="row row1">
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="fri[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="09">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="fri[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="fri[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="12">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="fri[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                     ...
                     <div class="card mb-3">
                        <div class="card-header">
                           <div class="custom-control custom-checkbox">
                              ...
                              <span class="ml-auto float-right"> <!-- This class will align content to the right -->
                                 <button class="btn btn-outline-success btn-sm js-whs__add-btn" type="button" id="sat[]">
                                    <i class="bi bi-plus"></i> Add
                                 </button>
                              </span>
                           </div>
                        ...
                        <div class="card-body">
                           <div class="row row1">
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="sat[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="09">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="sat[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
                                    </div>
                                 </div>
                              </div>
                              <div class="col-6">
                                 <div class="form-group">
                                    <div class="input-group">
                                       <input type="number" name="sat[]" class="form-control" aria-label="Hour" max="12" min="0" placeholder="09" value="12">
                                       <div class="input-group-append">
                                          <span class="input-group-text">:</span>
                                       </div>
                                       <input type="number" name="sat[]" class="form-control" aria-label="Minute" max="60" min="0" placeholder="00" value="00">
   ...
   <?php $this->load->view('admin/restaurant/add_business_type'); ?>
...
<script>
   document.addEventListener("DOMContentLoaded", function() {
      ...
      function createHourInputs(id) {
         ...
         startHourInput.setAttribute('name', id);
