...
<div class="modal fade" id="add-items" tabindex="-1" role="dialog">
    <div class="modal-dialog">
        <?php echo form_open(admin_url('processbuilder/create_activity'),array('id'=>'id')); ?>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php $value = (isset($activity) ? $activity: ''); ?>
                        <?php $attrs = (isset($activity) ? array() : array('autofocus' => true, 'placeholder' => 'Enter  activity')); ?>
                        <?php echo render_input('activity', 'Activity', $value, 'text', $attrs); ?>
...
<script>
    window.addEventListener('load', function() {
        ...
        $('#add-items input[activity="activity"]').val('');
        ...
        if (typeof(group_id) !== 'undefined') {
            ...
            $('#add-items input[name="activity"]').val($(invoker).parents('tr').find('td').eq(1).find('b').text());
