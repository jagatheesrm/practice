...
<?php init_head();
$has_permission_edit = has_permission('overhead', '', 'edit');
$has_permission_create = has_permission('overhead', '', 'create');
?>
<div id="wrapper">
    <div class="content">
        <div class="row">
                    ...
                    <div class="panel-body">
                        <div class="_buttons">
                            ...
                            <?php if ($has_permission_create) { ?>
                                <a href="#" onclick="new_service(); return false; " class="btn btn-info mright5"><?php echo 'New Overhead'; ?></a>
                            <?php } ?>
                            <a href="<?php echo admin_url('overhead/viewoverheadcycle'); ?>" class="btn btn-info mleft4"><?php echo 'View Overheads Cycle'; ?></a>
                            <a href="<?php echo admin_url('overhead/viewoverheadreport'); ?>" class="btn btn-info mleft4"><?php echo 'View Overheads Report'; ?></a>
                        </div>
...
<?php $this->load->view('admin/overhead/add_overhead'); ?>
<?php init_tail(); ?>
<script>
    $(function() {
    ...
    function initKnowledgeBaseTableArticles() {
        ...
        initDataTable('.table-articles', window.location.href, undefined, undefined,  [0, 'desc']);
    }
