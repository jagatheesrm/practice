                    ...
                    <div class="panel-body">
                        <div class="_buttons">
                            ...
                            <?php if ($has_permission_create) { ?>
                                <a href="#" onclick="new_service(); return false; " class="btn btn-info mright5"><?php echo 'New Overhead cycle'; ?></a>
                            <?php } ?>
                            <a href="<?php echo admin_url('overhead/viewoverheadreport'); ?>" class="btn btn-info mleft4"><?php echo 'View Overheads Report'; ?></a>
                            <a href="<?php echo admin_url('overhead/'); ?>" class="btn btn-info mleft4"><?php echo 'View Category'; ?></a>
                        </div>
...
<?php $this->load->view('admin/overhead/add_cycle'); ?>
<?php init_tail(); ?>
<script>
    $(function() {
