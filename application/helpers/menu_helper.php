...
function app_init_admin_sidebar_menu_items()
{
    ...
    $CI->app_menu->add_sidebar_menu_item('Restaurent', [
        ...
        'position' => 1,
        'icon'     => 'fa fa-cutlery', //fa fa-folder-open
        'badge'    => [],
    ]);

    $CI->app_menu->add_sidebar_menu_item('sales', [
        'name'     => _l('Sales'),
        'href'     => admin_url('sales'),
    ...
    $CI->app_menu->add_sidebar_menu_item('Departments', [
        ...
        'position' => 1,
        'icon'     => 'fa fa-suitcase', //fa fa-codepen
        'badge'    => [],
    ]);

    $CI->app_menu->add_sidebar_menu_item('Sales_channel', [
        'name'     => 'Saleschannel',
        'href'     => admin_url('Saleschannel'),
        'position' => 1,
        'icon'     => 'fa fa-universal-access', 
        'badge'    => [],
    ]);

    $CI->app_menu->add_sidebar_menu_item('Overhead', [
        'name'     => 'overhead',
        'href'     => admin_url('Overhead'),
        'position' => 1,
        'icon'     => 'fa fa-sitemap',
        'badge'    => [],
    ]);

    $CI->app_menu->add_sidebar_menu_item(' processbuilder', [
        'name'     => ' processbuilder',
        'href'     => admin_url('processbuilder'),
        'position' => 1,
    ...
    $CI->app_menu->add_sidebar_menu_item('items', [
        'name'     => 'Items',
        'href'     => admin_url('items'),
        'position' => 1,
        'icon'     => 'fa fa-search-plus',
        'badge'    => [],
    ]);

    $CI->app_menu->add_sidebar_menu_item('ingredients', [
        'name'     => 'Ingredients',
        'href'     => admin_url('ingredients'),
        'position' => 1,
        'icon'     => 'fa fa-search-plus',
        'badge'    => [],
    ]);

    $CI->app_menu->add_sidebar_menu_item('labour', [
        'name'     => 'Labour',
        'href'     => admin_url('labour'),
        'position' => 1,
        'icon'     => 'fa fa-search-plus',
        'badge'    => [],
    ]);
